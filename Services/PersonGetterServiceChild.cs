...
namespace Services
{
    public  class PersonGetterServiceChild:PersonsGetterService
    {
        public PersonGetterServiceChild(IPersonsRepository personsRepository, ILogger<PersonsAdderService> logger, IDiagnosticContext diagnosticContext)
