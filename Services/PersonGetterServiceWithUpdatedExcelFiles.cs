...
namespace Services
{
    public class PersonGetterServiceWithUpdatedExcelFiles : IPersonsGetterService
    {
        private readonly PersonsGetterService _personsGetterService;


        public PersonGetterServiceWithUpdatedExcelFiles(PersonsGetterService personsGetterService)
        {
